...
const ContactsList = (props) => {
  ...
  const contactsItems = contactsEdited.map((contact) => (
    <ContactItem
      key={contact.id}
      customerID={parseInt(contact.customerID)}
      ...
      // segementType={contact.segementType}
  ...
  return <Card className="contacts-list">{contactsItems}</Card>;
  // return <Card className="contacts-list">{}</Card>;
};
